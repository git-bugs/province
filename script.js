  ...
  return function (e) {
    ...
    function q(e) {
      var t,
          n,
          o,
          i = e.collections.sourcesOutersTransformers,
    ...
    function ee(e) {
      ...
      n = (t = e).core.classFacade, o = t.elements, n.removeFromEachElementClassIfContains = function (e, t) {
        ...
        n.displaySourcesWhichShouldBeDisplayed = function () {
          if (o) s(i.current);else for (var e in i) {
            s(i[e]);
          }
        };
      }(e), function (e) {
        ...
        i.runActions = function () {
          ...
          for (var e = 0; e < c.sources.length; e++) {
            U(r[e], u), e !== a.current && n[e].negative(), o[e] && o[e].styleSize();
          }
        };
      }(e);
    }
    ...
    function te(e) {
      ...
      n.isInitialized = !0, function (e) {
        for (var t = e.collections.sourcesOutersTransformers, n = e.props.sources, o = e.resolve, i = 0; i < n.length; i++) {
          t[i] = o(X, [i]);
        }
        ...
        for (var t = e.props.sources, n = e.resolve, o = n(w), i = n(k), s = n(R, [o, i]), r = 0; r < t.length; r++) {
    ...
    function le() {
      for (var e = document.getElementsByTagName("a"), t = function t(_t) {
        ...
        for (var r = ["href", "data-fslightbox", "data-type", "data-video-poster", "data-class", "data-custom-class"], c = e[_t].attributes, a = fsLightboxInstances[n].props.customAttributes, l = 0; l < c.length; l++) {
          if (-1 === r.indexOf(c[l].name)) {
            a[s] || (a[s] = {});
        ...
        function d(o, i) {
          e[_t].hasAttribute(i) && (fsLightboxInstances[n].props[o][s] = e[_t].getAttribute(i));
        }
      }, n = 0; n < e.length; n++) {
        t(n);
      }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _anch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./anch */ "./app/js/anch.js");
/* harmony import */ var _fslightbox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fslightbox */ "./app/js/fslightbox.js");


Object(_anch__WEBPACK_IMPORTED_MODULE_0__["default"])();
